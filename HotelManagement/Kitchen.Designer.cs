...
namespace Hotel_Manager
{
    partial class Kitchen
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.TodoTabPage = new TabPage();
            this.onTheLineLabel = new Label();
            this.updateButton = new Button();
            this.roomNLabel = new Label();
            this.floorNLabel = new Label();
            this.roomTypeLabel = new Label();
            this.Todo = new System.Windows.Forms.GroupBox();
            this.dinnerQTLabel = new Label();
            this.lunchQTLabel = new Label();
            this.breakfastQTLabel = new Label();
            this.breakfastTextBox = new TextBox();
            this.foodSelectionButton = new Button();
            this.supplyCheckBox = new CheckBox();
            this.lunchTextBox = new TextBox();
            this.towelCheckBox = new CheckBox();
